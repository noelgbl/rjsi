...
//! mutates it.
use rjsi::{
    Args, CallbackCx, ContextNativeStateExt, DefaultRuntime, Engine, Error, NativeState, NativeStateSupport, Result, Runtime, Value
};
...
fn increment<'cx, 'rt, E: Engine + NativeStateSupport>(
