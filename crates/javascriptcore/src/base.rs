...
use crate::{JSContext, JSException, JSObject, JSString, JSValue, sys};

/// Evaluates a string of JavaScript.
///
/// * `ctx`: The execution context to use.
/// * `script`: A string containing the script to evaluate.
/// * `this_object`: The optional object to use as `this`, or `None` to use the
///   global object as `this`.
/// * `source_url`: An optional string containing a URL for the script's source
///   file. This is used by debuggers and when reporting exceptions. Pass `None`
///   if you do not care to include source file information.
/// * `starting_line_number`: An integer value specifying the script's starting
///   line number in the file located at `source_url`. This is only used when
///   reporting exceptions. The value is one-based, so the first line is line
///   `1` and invalid values are clamped to `1`.
///
...
/// * `source_url`: An optional string containing a URL for the script's source
///   file. This is only used when reporting exceptions. Pass `None` if you do
